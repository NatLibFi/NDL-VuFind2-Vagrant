...
# do this before installing composer!
...
sudo su vagrant -c '/usr/local/bin/composer install'
sudo su vagrant -c '/usr/local/bin/composer install-build-deps'
#sudo su vagrant -c '/usr/local/bin/composer dump-autoload'
